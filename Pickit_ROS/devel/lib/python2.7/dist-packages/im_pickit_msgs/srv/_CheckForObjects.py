...
"""autogenerated by genpy from im_pickit_msgs/CheckForObjectsRequest.msg. Do not edit."""
import sys
...
class CheckForObjectsRequest(genpy.Message):
  _md5sum = "d41d8cd98f00b204e9800998ecf8427e"
  _type = "im_pickit_msgs/CheckForObjectsRequest"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CheckForObjectsRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from im_pickit_msgs/CheckForObjectsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CheckForObjectsResponse(genpy.Message):
  _md5sum = "991a96571e9f4e20d906edfcd9ce097d"
  _type = "im_pickit_msgs/CheckForObjectsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
string detail
"""
  __slots__ = ['success','objects']
  _slot_types = ['bool','im_pickit_msgs/ObjectArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CheckForObjectsResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.success is None:
        self.success = False
      if self.objects is None:
        self.objects = im_pickit_msgs.msg.ObjectArray()
    else:
      self.success = False
      self.objects = im_pickit_msgs.msg.ObjectArray()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.success, _x.objects.header.seq, _x.objects.header.stamp.secs, _x.objects.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_get_struct_B4I().pack(_x.objects.content, _x.objects.encoder_stamp, _x.objects.robot_to_camera_tf.header.seq, _x.objects.robot_to_camera_tf.header.stamp.secs, _x.objects.robot_to_camera_tf.header.stamp.nsecs))
      _x = self.objects.robot_to_camera_tf.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.objects.robot_to_camera_tf.child_frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.objects.robot_to_camera_tf.transform.translation.x, _x.objects.robot_to_camera_tf.transform.translation.y, _x.objects.robot_to_camera_tf.transform.translation.z, _x.objects.robot_to_camera_tf.transform.rotation.x, _x.objects.robot_to_camera_tf.transform.rotation.y, _x.objects.robot_to_camera_tf.transform.rotation.z, _x.objects.robot_to_camera_tf.transform.rotation.w, _x.objects.camera_to_reference_tf.header.seq, _x.objects.camera_to_reference_tf.header.stamp.secs, _x.objects.camera_to_reference_tf.header.stamp.nsecs))
      _x = self.objects.camera_to_reference_tf.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.objects.camera_to_reference_tf.child_frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_8dBH2d2H().pack(_x.objects.camera_to_reference_tf.transform.translation.x, _x.objects.camera_to_reference_tf.transform.translation.y, _x.objects.camera_to_reference_tf.transform.translation.z, _x.objects.camera_to_reference_tf.transform.rotation.x, _x.objects.camera_to_reference_tf.transform.rotation.y, _x.objects.camera_to_reference_tf.transform.rotation.z, _x.objects.camera_to_reference_tf.transform.rotation.w, _x.objects.cloud_capturing_duration, _x.objects.clustering_method, _x.objects.n_rejected_clusters, _x.objects.clustering_duration, _x.objects.calculation_time, _x.objects.n_valid_objects, _x.objects.n_rejected_objects))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.objects.header.seq, _x.objects.header.stamp.secs, _x.objects.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      ...
      (_x.objects.content, _x.objects.encoder_stamp, _x.objects.robot_to_camera_tf.header.seq, _x.objects.robot_to_camera_tf.header.stamp.secs, _x.objects.robot_to_camera_tf.header.stamp.nsecs,) = _get_struct_B4I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.objects.robot_to_camera_tf.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.objects.robot_to_camera_tf.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.objects.robot_to_camera_tf.child_frame_id = str[start:end].decode('utf-8')
      else:
        self.objects.robot_to_camera_tf.child_frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.objects.robot_to_camera_tf.transform.translation.x, _x.objects.robot_to_camera_tf.transform.translation.y, _x.objects.robot_to_camera_tf.transform.translation.z, _x.objects.robot_to_camera_tf.transform.rotation.x, _x.objects.robot_to_camera_tf.transform.rotation.y, _x.objects.robot_to_camera_tf.transform.rotation.z, _x.objects.robot_to_camera_tf.transform.rotation.w, _x.objects.camera_to_reference_tf.header.seq, _x.objects.camera_to_reference_tf.header.stamp.secs, _x.objects.camera_to_reference_tf.header.stamp.nsecs,) = _get_struct_7d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.objects.camera_to_reference_tf.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.objects.camera_to_reference_tf.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.objects.camera_to_reference_tf.child_frame_id = str[start:end].decode('utf-8')
      else:
        self.objects.camera_to_reference_tf.child_frame_id = str[start:end]
      _x = self
      start = end
      end += 87
      (_x.objects.camera_to_reference_tf.transform.translation.x, _x.objects.camera_to_reference_tf.transform.translation.y, _x.objects.camera_to_reference_tf.transform.translation.z, _x.objects.camera_to_reference_tf.transform.rotation.x, _x.objects.camera_to_reference_tf.transform.rotation.y, _x.objects.camera_to_reference_tf.transform.rotation.z, _x.objects.camera_to_reference_tf.transform.rotation.w, _x.objects.cloud_capturing_duration, _x.objects.clustering_method, _x.objects.n_rejected_clusters, _x.objects.clustering_duration, _x.objects.calculation_time, _x.objects.n_valid_objects, _x.objects.n_rejected_objects,) = _get_struct_8dBH2d2H().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
...
def _get_struct_3d():
    ...
    return _struct_3d
class CheckForObjects(object):
  _type          = 'im_pickit_msgs/CheckForObjects'
  _md5sum = '991a96571e9f4e20d906edfcd9ce097d'
  _request_class  = CheckForObjectsRequest
  _response_class = CheckForObjectsResponse
