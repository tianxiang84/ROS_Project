...
"""autogenerated by genpy from im_pickit_msgs/BoundingBox.msg. Do not edit."""
import sys
...
class BoundingBox(genpy.Message):
  ...
  _type = "im_pickit_msgs/BoundingBox"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This contains the limits of a bounding box
float64 x_min
float64 x_max
float64 y_min
float64 y_max
