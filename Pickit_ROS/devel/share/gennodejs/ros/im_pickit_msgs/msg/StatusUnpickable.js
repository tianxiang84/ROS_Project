...
class StatusUnpickable {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StatusUnpickable(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StatusUnpickable(null);
    return resolved;
    }
};

// Constants for message
StatusUnpickable.Constants = {
  CATEGORY: 'UNPICKABLE',
...
module.exports = StatusUnpickable;
